      ...
      >
        ...
        >
          <p className="max-w-md text-foreground/70 leading-relaxed">
            Une maison tunisienne dédiée au vestiaire masculin. Tailleur, denim brut, maille lourde
            — coupés à la main, pensés pour traverser les saisons.
          </p>
    ...
    <section id="collections" className="px-6 md:px-12 py-24 md:py-36">
      <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8 mb-16 md:mb-24">
        ...
        <p className="text-foreground/70 max-w-sm leading-relaxed">
          Chaque pièce est coupée pour tenir l'épaule, tomber juste, et vieillir avec celui qui la
          porte. Rien de superflu.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
        {collections.map((c, i) => (
          ...
          >
            <RouterLink to="/collections" className="block">
    ...
    >
      <div className="grid grid-cols-12 gap-6 md:gap-10 items-end">
        <div className="col-span-12 md:col-span-5">
          ...
          >
            Photographié entre Tunis et Milan, le lookbook hiver met en avant les laines lourdes,
            les cuirs patinés et le détail d'un poignet bien coupé.
          </motion.p>
          <motion.a
            href="#"
            variants={fadeUp}
        ...
        <div className="col-span-12 md:col-span-6 md:pl-8">
          ...
          <div className="mt-8 space-y-5 text-foreground/70 leading-relaxed max-w-lg">
            <p>
              ...
              trois générations : tracer la craie, monter l'épaule à la main, ajuster l'aplomb d'une
              veste sur l'homme qui la portera.
            </p>
            <p>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-10 md:gap-12">
        <div className="col-span-2">
          <div className="font-display text-3xl">
            Marco Benucci<span className="text-accent">.</span>
          </div>
